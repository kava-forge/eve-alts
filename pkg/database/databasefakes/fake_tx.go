...
func (fake *FakeTx) QueryRowContext(arg1 context.Context, arg2 string, arg3 ...interface{}) *sql.Row {
...
func (fake *FakeTx) QueryRowContextCalls(stub func(context.Context, string, ...interface{}) *sql.Row) {
	fake.queryRowContextMutex.Lock()
...
func (fake *FakeTx) QueryRowContextReturns(result1 *sql.Row) {
	fake.queryRowContextMutex.Lock()
	defer fake.queryRowContextMutex.Unlock()
...
func (fake *FakeTx) QueryRowContextReturnsOnCall(i int, result1 *sql.Row) {
	fake.queryRowContextMutex.Lock()
	defer fake.queryRowContextMutex.Unlock()
	fake.QueryRowContextStub = nil
